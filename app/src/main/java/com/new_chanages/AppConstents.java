...
//QA
   // public static final String BASE_URL = "http:/182.18.177.27:78/mypbR/public/";

    //prod
    public static final String BASE_URL = "http://admin.mypollbook.com/";
    public static final String TOPUSERS=BASE_URL+"api/v1/topusers";
