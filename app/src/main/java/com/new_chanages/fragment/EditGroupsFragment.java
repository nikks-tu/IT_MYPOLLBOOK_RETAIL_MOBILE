...
import com.contusfly.createpoll.ContactDisplay;
import com.contusfly.createpoll.CreatePollOptions;
...
public class EditGroupsFragment extends Fragment implements GroupPolls.GroupPollOnFragmentInteractionListner{
        ...
        groups_recyclerview.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), groups_recyclerview, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
               ...
               // Toast.makeText(mContext, ""+groupId, Toast.LENGTH_SHORT).show();
                ...
                /*imageChangeFragment(new GroupCreate(), groupsList.get(position).getGroupId());*/
    ...
    private void imageChangeFragment(Fragment targetFragment, Integer groupId) {
        ...
        //Visibility gone
        customFragment.setVisibility(View.VISIBLE);
        //set visibility view
