...
public class GridAdapterContacts extends ArrayAdapter<ContactModel> {
    private final int resource;
    private Context mContext;
    ArrayList<ContactModel> list;

    public GridAdapterContacts(@NonNull Context context, int resource, @NonNull ArrayList<ContactModel> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String imageUrl = item.getContactPic();
