...
public class EditProfile extends ActivityBase implements OnTaskCompleted {
    ...
    private void init() {
        ...
        //Lollipop version status bar black
        ...
        MApplication.hideButtonKeypadOpens(mProfileEdit, rootView, txtDone, txtView, txtCancel, view5);
        //Setting the text
        ...
        //Setting the text
        String gen = MApplication.getString(mProfileEdit, Constants.USER_GENDER);
       // Toast.makeText(mProfileEdit, "Gender "+ gen, Toast.LENGTH_SHORT).show();
            ...
            case PERMISSION_ALL: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (perms.get(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
                        ...
                        editProfileChoosePic(EditProfile.this);
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            switch (which) {
                                                case DialogInterface.BUTTON_POSITIVE:
                                                    hasPermissions(EditProfile.this, PERMISSIONS);
                                                    break;
