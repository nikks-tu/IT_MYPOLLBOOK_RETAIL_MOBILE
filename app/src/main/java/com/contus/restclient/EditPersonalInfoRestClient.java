...
import com.contus.apiinterface.EditPersonalInfoInterface;
 ...
 */
public class EditPersonalInfoRestClient {
    private static EditPersonalInfoInterface sPersonalInterface;/** The s settings api interface. */
     ...
     */
    private EditPersonalInfoRestClient() {
     ...
     */
    public static EditPersonalInfoInterface getInstance() {
...
//The REST adapter allows your store to communicate with an HTTP server by transmitting JSON via XHR.
        ...
        sPersonalInterface = restAdapter.create(EditPersonalInfoInterface.class);
    }
}
