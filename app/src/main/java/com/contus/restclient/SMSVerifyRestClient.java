...
import com.contus.apiinterface.SMSverifyApi;
 ...
 */
public class SMSVerifyRestClient {
    private static SMSverifyApi sTermsApiInterface;/** The s settings api interface. */
     ...
     */
    public static SMSverifyApi getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sTermsApiInterface = restAdapter.create(SMSverifyApi.class);
    }
