...
import com.contus.apiinterface.PollReviewApiInterface;
 ...
 */
public class PollReviewQuestionRestClient {
    private static PollReviewApiInterface sWelcomeApiInterface; /** The s settings api interface. */
     ...
     */
    private PollReviewQuestionRestClient() {
     ...
     */
    public static PollReviewApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sWelcomeApiInterface = restAdapter.create(PollReviewApiInterface.class);
    }
}
