...
import com.contus.apiinterface.ContactApiInterface;
...
public class ContactsRestClient {
    private static ContactApiInterface sPersonalInterface; /** The s settings api interface. */
     ...
     */
    public static ContactApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sPersonalInterface = restAdapter.create(ContactApiInterface.class);
    }
}
