...
import com.contus.apiinterface.ContactUseApiInterface;
 ...
 */
public class ContactUsRestClient {
    private static ContactUseApiInterface sPersonalInterface; /** The s settings api interface. */
     ...
     */
    public static ContactUseApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sPersonalInterface = restAdapter.create(ContactUseApiInterface.class);
    }
}
