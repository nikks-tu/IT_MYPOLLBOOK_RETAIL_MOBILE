...
import com.contus.apiinterface.PrivatePollApiInterface;
 ...
 */
public class PrivatePollRestClient {
    private static PrivatePollApiInterface sWelcomeApiInterface;/** The s settings api interface. */
     ...
     */
    public static PrivatePollApiInterface getInstance() {
...
//HTTP is the way modern applications network. It�s how we exchange data & media.
        ...
        sWelcomeApiInterface = restAdapter.create(PrivatePollApiInterface.class);
    }
}
