...
import com.contusfly.createpoll.CreatePollApiInterface;
 ...
 */
public class CreatePollRestClient {
    private static CreatePollApiInterface sWelcomeApiInterface;/** The s settings api interface. */
     ...
     */
    public static CreatePollApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        okHttp.setConnectTimeout(240, TimeUnit.SECONDS);
        //HTTP is the way modern applications network. It�s how we exchange data & media.
        // Doing HTTP efficiently makes your stuff load faster and saves bandwidth.
...
//The REST adapter allows your store to communicate with an HTTP server by transmitting JSON via XHR.
        ...
        sWelcomeApiInterface = restAdapter.create(CreatePollApiInterface.class);
    }
}
