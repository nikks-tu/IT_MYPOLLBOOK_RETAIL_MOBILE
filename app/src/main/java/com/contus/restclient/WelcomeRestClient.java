...
import com.contus.apiinterface.WelcomeApiInterface;
...
public class WelcomeRestClient {
    private static WelcomeApiInterface sWelcomeApiInterface;/** The s settings api interface. */
     ...
     */
    public static WelcomeApiInterface getInstance() {
...
//HTTP is the way modern applications network. It�s how we exchange data & media.
        ...
        sWelcomeApiInterface = restAdapter.create(WelcomeApiInterface.class);
    }
}