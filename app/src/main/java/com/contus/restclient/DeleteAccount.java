...
import com.contus.apiinterface.DeleteApiInterface;
...
public class DeleteAccount {
    private static DeleteApiInterface sWelcomeApiInterface;/** The s settings api interface. */
     ...
     */
    public static DeleteApiInterface getInstance() {
...
//The REST adapter allows your store to communicate with an HTTP server by transmitting JSON via XHR.
        ...
        sWelcomeApiInterface = restAdapter.create(DeleteApiInterface.class);
    }
}
