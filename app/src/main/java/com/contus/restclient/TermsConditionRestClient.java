...
import com.contus.apiinterface.TermApiInterface;
 ...
 */
public class TermsConditionRestClient {
    private static TermApiInterface sTermsApiInterface; /** The s settings api interface. */
     ...
     */
    private TermsConditionRestClient() {
     ...
     */
    public static TermApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sTermsApiInterface = restAdapter.create(TermApiInterface.class);
    }
}