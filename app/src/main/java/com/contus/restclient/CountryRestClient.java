...
import com.contus.apiinterface.CountryApiInterface;
...
private static CountryApiInterface sCountryApiInterface;/** The s settings api interface. */
 ...
 */
public static CountryApiInterface getInstance() {
        return sCountryApiInterface;
        }
...
//create the rest adapter   
 sCountryApiInterface = restAdapter.create(CountryApiInterface.class);
        }
        }