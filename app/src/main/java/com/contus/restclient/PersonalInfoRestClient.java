...
import com.contus.apiinterface.PersonalInfoApiInterface;
 ...
 */
public class PersonalInfoRestClient {
    private static PersonalInfoApiInterface sPersonalInterface;/** The s settings api interface. */
     ...
     */
    private PersonalInfoRestClient() {
     ...
     */
    public static PersonalInfoApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        okHttp.setConnectTimeout(10000, TimeUnit.SECONDS);
        //HTTP is the way modern applications network. It�s how we exchange data & media.
        // Doing HTTP efficiently makes your stuff load faster and saves bandwidth.
        ...
        sPersonalInterface = restAdapter.create(PersonalInfoApiInterface.class);
    }
}
