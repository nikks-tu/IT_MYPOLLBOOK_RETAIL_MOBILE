...
import com.contus.apiinterface.PollDeleteApiInterface;
...
public class PollDelete {
    private static PollDeleteApiInterface sWelcomeApiInterface;/** The s settings api interface. */
     ...
     */
    public static PollDeleteApiInterface getInstance() {
...
//create the rest adapter
        sWelcomeApiInterface = restAdapter.create(PollDeleteApiInterface.class);
    }
}
