...
import com.contus.apiinterface.PollReviewInterface;
 ...
 */
public class PollReviewsRestClient {
    private static PollReviewInterface sWelcomeApiInterface;/** The s settings api interface. */
     ...
     */
    public static PollReviewInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sWelcomeApiInterface = restAdapter.create(PollReviewInterface.class);
    }
}
