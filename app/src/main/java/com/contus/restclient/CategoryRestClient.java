...
import com.contus.apiinterface.CategoryApiInterface;
...
public class CategoryRestClient {
    private static CategoryApiInterface sWelcomeApiInterface;   /** The s settings api interface. */
     ...
     */
    public static CategoryApiInterface getInstance() {
    ...
    private static void setupRestClient() {
        ...
        sWelcomeApiInterface = restAdapter.create(CategoryApiInterface.class);
    }
}
