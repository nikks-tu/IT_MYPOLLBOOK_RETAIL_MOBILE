...
public class RoundedCornersTransformation implements Transformation<Bitmap> {
   ...
   * @param cornerType
   */
  public RoundedCornersTransformation(Context context, int radius, int radius2,  int margin,
                                     CornerType cornerType) {
    this(Glide.get(context).getBitmapPool(), radius,radius2, margin, cornerType);
  }

  public RoundedCornersTransformation(BitmapPool pool, int radius,int radius2, int margin,
      CornerType cornerType) {
    mBitmapPool = pool;
    mRadius = radius;
    mRadius1=radius2;
  ...
  private void drawRoundRect(Canvas canvas, Paint paint, float width, float height) {
    ...
    float bottom = height - mRadius;

    switch (mCornerType) {
      case ALL:
       canvas.drawRoundRect(new RectF(mMargin, mMargin, right, bottom), mRadius, mRadius1, paint);
       // canvas.drawRoundRect(right,bottom,right,bottom,mRadius,mRadius,paint);
        break;
      case TOP_LEFT:
