...
public class PrivatePollCommentsAdapter extends ArrayAdapter<CommentDisplayResponseModel.Results.Data> {
     ...
     * @param userId
     */
    public PrivatePollCommentsAdapter(Activity activity, List<CommentDisplayResponseModel.Results.Data> dataResults, int layoutId, String id, String userId, int commentsCountPosition) {
