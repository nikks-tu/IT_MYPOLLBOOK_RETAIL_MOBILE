...
public class PrivatePollsCustomAdapter extends ArrayAdapter<PrivatePollResponseModel.Results.Data> implements CompoundButton.OnCheckedChangeListener{
    ...
    private View.OnClickListener mQuestionImage1 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //Question image
            pollImage1 = userPollResponse.getUserPollsQuestion().getPollQuestionImage().replaceAll(" ", "%20");
    ...
    private View.OnClickListener mQuestionImage2 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            userPollResponse = getItem(clickPosition);
            //Question image
            pollImage2 = userPollResponse.getUserPollsQuestion().getPollQuestionImage1().replaceAll(" ", "%20");
            //This method will be called wto show th eimage in full view
    ...
    private View.OnClickListener mSingleOption = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            userPollResponse = getItem(clickPosition);
            //Question image
            if (("").equals(userPollResponse.getUserPollsQuestion().getPollQuestionImage1())) {
                image = userPollResponse.getUserPollsQuestion().getPollQuestionImage().replaceAll(" ", "%20");
            } else {
                image = userPollResponse.getUserPollsQuestion().getPollQuestionImage1().replaceAll(" ", "%20");
            }
            //This method will be called wto show th eimage in full view
     ...
     * @param list
     */
    public PrivatePollsCustomAdapter(Activity activity, List<PrivatePollResponseModel.Results.Data> dataResults, int layoutId, String userId, EndLessListView list) {
    ...
    private void imageQuestionClickAction(int clickPosition, String pollImageMyPoll) {
        ...
        MApplication.setString(userPollActivity, Constants.DATE_UPDATED, MApplication.getTimeDifference(userPollResponse.getUpdatedAt()));
        //Setting the name in prefernce
        MApplication.setString(userPollActivity, Constants.CAMPAIGN_NAME, userPollResponse.getUserInfo().getUserName());
        //Setting the category in prefernce
        MApplication.setString(userPollActivity, Constants.CAMPAIGN_CATEGORY, userPollResponse.getCategory().getCategory().getCategoryName());
        //Setting the logo in prefernce
        MApplication.setString(userPollActivity, Constants.CAMPAIGN_LOGO, userPollResponse.getUserInfo().getUserProfileImg());
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        pollAnswer1 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer1();
        //poll answer form the response
        pollAnswer2 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer2();
        //poll answer form the response
        pollAnswer3 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer3();
        //poll answer form the response
        pollAnswer4 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer4();
        //youtube usrl from tthe response
        youTubeUrl = userPollResponse.getUserPollsQuestion().getYouTubeUrl();
        ...
        if (Integer.parseInt(idRefrenceView) == Constants.LAYOUT_ONE) {
            ...
            holderUserView1.radioYesOrNoUserPoll = (RadioGroup) mMyPollsView.findViewById(R.id.YesOrNO);
            holderUserView1.radioYesUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.radioYes);
            holderUserView1.radioNoUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.radioNo);
            holderUserView1.likeUnlikeYesOrNoPoll = (CheckBox) mMyPollsView.findViewById(R.id.unLikeDislike);
            holderUserView1.txtLikeYesOrNoUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtLike2);
            holderUserView1.imageQuestion1YesOrNoPoll = (ImageView) mMyPollsView.findViewById(R.id.choose);
            holderUserView1.imageQuestion2YesOrNoPoll = (ImageView) mMyPollsView.findViewById(R.id.ChooseAdditional);
            holderUserView1.singleOptionYesOrNoPoll = (ImageView) mMyPollsView.findViewById(R.id.singleOption);
            holderUserView1.txtQuestionYesOrNoPoll = (TextView) mMyPollsView.findViewById(R.id.txtStatus);
            holderUserView1.txtCommentYesOrNoPoll = (TextView) mMyPollsView.findViewById(R.id.txtCommentsCounts);
            holderUserView1.txtCountsYesOrNoPoll = (TextView) mMyPollsView.findViewById(R.id.txtParticcipation);
            holderUserView1.txtNameYesOrNoPoll = (TextView) mMyPollsView.findViewById(R.id.txtName);
            holderUserView1.txtTimeYesOrNoPoll = (TextView) mMyPollsView.findViewById(R.id.txtTime);
            holderUserView1.txtCategoryYesOrNoPoll = (TextView) mMyPollsView.findViewById(R.id.txtCategory);
            holderUserView1.imgProfileYesOrNoPoll = (ImageView) mMyPollsView.findViewById(R.id.imgProfile);
            holderUserView1.imgShareYesOrNoUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgShare);
            ...
            holderUserView2.radioGroupOptionsMultipleOptionsUserPoll = (RadioGroup) mMyPollsView.findViewById(R.id.participate_options);
            holderUserView2.radioOptions1MultipleOptionsUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option1);
            holderUserView2.radioOptions2MultipleOptionsUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option2);
            holderUserView2.radioOptions3MultipleOptionsUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option3);
            holderUserView2.radioOptions4MultipleOptionsUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option4);
            holderUserView2.likeUnlikeMultipleOptionsUserPoll = (CheckBox) mMyPollsView.findViewById(R.id.unLikeDislike);
            holderUserView2.txtLikeMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtLike2);
            holderUserView2.txtNameMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtName);
            holderUserView2.txtTimeMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtTime);
            holderUserView2.txtCategoryMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtCategory);
            holderUserView2.imgProfileMultipleOptionsUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgProfile);
            holderUserView2.txtQuestionMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtStatus);
            holderUserView2.txtCommentsMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtCommentsCounts);
            holderUserView2.txtCountsMultipleOptionsUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtParticcipation);
            holderUserView2.imageQuestion1MultipleOptionsUserPoll = (ImageView) mMyPollsView.findViewById(R.id.choose);
            holderUserView2.imageQuestion2MultipleOptionsUserPoll = (ImageView) mMyPollsView.findViewById(R.id.ChooseAdditional);
            holderUserView2.singleOptionMultipleOptionsUserPoll = (ImageView) mMyPollsView.findViewById(R.id.singleOption);
            holderUserView2.imgShareMultipleOptionsUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgShare);
            //Binding the data into the views in android
            ...
            holderUserView3.radioOptions1PhotoComparisonUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option1);
            holderUserView3.radioOptions2PhotoComparisonUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option2);
            holderUserView3.radioOptions3PhotoComparisonUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option3);
            holderUserView3.radioOptions4PhotoComparisonUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option4);
            holderUserView3.likeUnlikePhotoComparisonUserPoll = (CheckBox) mMyPollsView.findViewById(R.id.unLikeDislike);
            holderUserView3.txtLikePhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtLike2);
            holderUserView3.txtQuestionPhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtStatus);
            holderUserView3.imageAnswer1PhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.answer1);
            holderUserView3.imageAnswer2PhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.answer2);
            holderUserView3.imageAnswer3PhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.answer3);
            holderUserView3.imageAnswer4PhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.answer4);
            holderUserView3.relativeAnswer3PhotoComparisonUserPoll = (RelativeLayout) mMyPollsView.findViewById(R.id.ThirdOptionOption);
            holderUserView3.relativeAnswer4PhotoComparisonUserPoll = (RelativeLayout) mMyPollsView.findViewById(R.id.FourthOptionOption);
            holderUserView3.likeUnlikePhotoComparisonUserPoll = (CheckBox) mMyPollsView.findViewById(R.id.unLikeDislike);
            holderUserView3.txtLikePhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtLike2);
            holderUserView3.txtCommentsPhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtCommentsCounts);
            holderUserView3.txtCountPhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtParticcipation);
            holderUserView3.imageQuestion1PhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.choose);
            holderUserView3.imageQuestion2PhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.ChooseAdditional);
            holderUserView3.singleOptionPhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.singleOption);
            holderUserView3.txtNamePhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtName);
            holderUserView3.txtTimePhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtTime);
            holderUserView3.txtCategoryPhotoComparisonUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtCategory);
            holderUserView3.imgProfilePhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgProfile);
            holderUserView3.imgSharePhotoComparisonUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgShare);
            //Binding the data into the views in android
            ...
            holderUserView4 = new ViewHolderLayoutFour();
            holderUserView4.radioGroupOptionsYouTubeUrlUserPoll = (RadioGroup) mMyPollsView.findViewById(R.id.participate_options);
            holderUserView4.radioOptions1YouTubeUrlUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option1);
            holderUserView4.radioOptions2YouTubeUrlUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option2);
            holderUserView4.radioOptions3YouTubeUrlUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option3);
            holderUserView4.radioOptions4YouTubeUrlUserPoll = (RadioButton) mMyPollsView.findViewById(R.id.option4);
            holderUserView4.likeUnlikeYouTubeUrlUserPoll = (CheckBox) mMyPollsView.findViewById(R.id.unLikeDislike);
            holderUserView4.txtLikeYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtLike2);
            holderUserView4.txtQuestionYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtStatus);
            holderUserView4.txtCommentsYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtCommentsCounts);
            holderUserView4.txtVideoUrlCountYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtParticcipation);
            holderUserView4.imageQuestion1YouTubeUrlUserPoll = (ImageView) mMyPollsView.findViewById(R.id.choose);
            holderUserView4.imageQuestion2YouTubeUrlUserPoll = (ImageView) mMyPollsView.findViewById(R.id.ChooseAdditional);
            holderUserView4.singleOptionYouTubeUrlUserPoll = (ImageView) mMyPollsView.findViewById(R.id.singleOption);
            holderUserView4.txtNameYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtName);
            holderUserView4.txtTimeYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtTime);
            holderUserView4.txtCategoryYouTubeUrlUserPoll = (TextView) mMyPollsView.findViewById(R.id.txtCategory);
            holderUserView4.imgProfileYouTubeUrlUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgProfile);
            holderUserView4.imgShareYouTubeUrlUserPoll = (ImageView) mMyPollsView.findViewById(R.id.imgShare);
            //Binding the data into the views in android
    ...
    private void clickAction(int clickPosition) {
        ...
        preferenceUserPollIdAnswer = MApplication.loadStringArray(userPollActivity, userPollIdAnwserCheck, Constants.USER_POLL_ID_ANSWER_ARRAY, Constants.USER_POLL_ID_ANSWER_SIZE);
        ...
        String pollId = userPollResponse.getUserPollsQuestion().getId();
        if(!preferenceUserPollIdAnswer.isEmpty()) {
            if (preferenceUserPollIdAnswer.contains(userPollResponse.getUserPollsQuestion().getId())) {
                //Load the participate count from  the saved prefernce
                preferenceUserPollParticipateCount = MApplication.loadArray(userPollActivity, userPollParticipateCount, Constants.USER_POLL_PARTICIPATE_COUNT_ARRAY, Constants.USER_POLL_PARTICIPATE_COUNT_SIZE);
                //Setting the time in prefernce
                MApplication.setString(userPollActivity, Constants.DATE_UPDATED, MApplication.getTimeDifference(userPollResponse.getUpdatedAt()));
                ...
                a.putExtra(Constants.PARTICIPATE_COUNT, String.valueOf(preferenceUserPollParticipateCount.get(clickPosition)));
                //Starting the activity
                userPollActivity.startActivity(a);
            }
            else {
    ...
    private void validateViewLayoutOne(final ViewHolderLayoutOne holder, final int position) {
        prefrenceUserPollLikeCount = MApplication.loadArray(userPollActivity, userPollLikeCount, Constants.USER_POLL_LIKES_COUNT_ARRAY, Constants.USER_POLL_LIKES_COUNT_SIZE);   //Load the like count from  the saved prefernce
        prefrenceUserPollCommentsCount = MApplication.loadArray(userPollActivity, userPollcommentsCount, Constants.USER_POLL_COMMENTS_COUNT, Constants.USER_POLL_COMMENTS_SIZE);//Load the COMMENTS count from  the saved prefernce
        //Load the like user from  the saved prefernce
        preferenceUserPollLikeUser = MApplication.loadArray(userPollActivity, userPollLikesUser, Constants.USER_POLL_LIKES_USER_ARRAY, Constants.USER_POLL_LIKES_USER_SIZE);
        //Load the poll id from  the saved prefernce
        preferenceUserPollIdAnswer = MApplication.loadStringArray(userPollActivity, userPollIdAnwserCheck, Constants.USER_POLL_ID_ANSWER_ARRAY, Constants.USER_POLL_ID_ANSWER_SIZE);
        //Load the answer from  the saved prefernce
        preferenceUserPollIdAnswerSelected = MApplication.loadStringArray(userPollActivity, userPollIdAnwser, Constants.USER_POLL_ID_ANSWER_SELECTED_ARRAY, Constants.USER_POLL_ID_SELECTED_SIZE);
...
//If the loaded poll id matches with the response id based on the position
        ...
        if (preferenceUserPollIdAnswer.contains(userPollResponse.getUserPollsQuestion().getId())) {
            ...
            int answeredPosition = preferenceUserPollIdAnswer.indexOf(userPollResponse.getUserPollsQuestion().getId());
        ...
        if (("").equals(pollImage1) && ("").equals(pollImage2)) {
            ...
            if (!("").equals(pollImage1) && !("").equals(pollImage2)) {
                ...
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.imageQuestion1YesOrNoPoll,R.drawable.placeholder_image);
                //Loading into the gilde
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage2,holder.imageQuestion2YesOrNoPoll,R.drawable.placeholder_image);
                ...
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.singleOptionYesOrNoPoll,R.drawable.placeholder_image);
                //visiblity gone
                holder.imageQuestion1YesOrNoPoll.setVisibility(View.GONE);
                //visiblity gone
                holder.imageQuestion2YesOrNoPoll.setVisibility(View.GONE);
                ...
                holder.singleOptionYesOrNoPoll.setVisibility(View.VISIBLE);
                ////Loading using the gilde into the imageview
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage2,holder.singleOptionYesOrNoPoll,R.drawable.placeholder_image);
                //Visiblity gone
                holder.imageQuestion1YesOrNoPoll.setVisibility(View.GONE);
                //Visiblity gone
                holder.imageQuestion2YesOrNoPoll.setVisibility(View.GONE);
        ...
        holder.txtNameYesOrNoPoll.setText(MApplication.getDecodedString(userPollResponse.getUserInfo().getUserName()));
        //Getting the time from the response and binding the data into the text view
        holder.txtTimeYesOrNoPoll.setText(MApplication.getTimeDifference(userPollResponse.getUpdatedAt()));
        //Getting the category name from the response and binding the data into the text view
        holder.txtCategoryYesOrNoPoll.setText(userPollResponse.getCategory().getCategory().getCategoryName());
        //Getting the category name from the response and binding the data into the text view
        Utils.loadImageWithGlideRounderCorner(userPollActivity,userPollResponse.getUserInfo().getUserProfileImg().replaceAll(" ", "%20"),holder.imgProfileYesOrNoPoll,R.drawable.placeholder_image);
        ...
        holderUserView1.radioYesOrNoUserPoll.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.radioYes) {   //If the id matches the below functionality will take place
                    ...
                    //poll answer
                    pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer1();
                    ...
                    //poll answer
                    pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer2();
                    //Option selection request
                    optionSelection(userPollResponse, clickPosition, holderUserView1, null, null, null);
                }
            }
    ...
    private void validateViewLayoutTwo(final ViewHolderLayoutTwo holder, final int position) {
        prefrenceUserPollLikeCount = MApplication.loadArray(userPollActivity, userPollLikeCount, Constants.USER_POLL_LIKES_COUNT_ARRAY, Constants.USER_POLL_LIKES_COUNT_SIZE); //Load the like count from  the saved prefernce
        prefrenceUserPollCommentsCount = MApplication.loadArray(userPollActivity, userPollcommentsCount, Constants.USER_POLL_COMMENTS_COUNT, Constants.USER_POLL_COMMENTS_SIZE); //Load the COMMENTS count from  the saved prefernce
        preferenceUserPollLikeUser = MApplication.loadArray(userPollActivity, userPollLikesUser, Constants.USER_POLL_LIKES_USER_ARRAY, Constants.USER_POLL_LIKES_USER_SIZE); //Load the like user from  the saved prefernce
        preferenceUserPollIdAnswer = MApplication.loadStringArray(userPollActivity, userPollIdAnwserCheck, Constants.USER_POLL_ID_ANSWER_ARRAY, Constants.USER_POLL_ID_ANSWER_SIZE);//Load the poll id from  the saved prefernce
        preferenceUserPollIdAnswerSelected = MApplication.loadStringArray(userPollActivity, userPollIdAnwser, Constants.USER_POLL_ID_ANSWER_SELECTED_ARRAY, Constants.USER_POLL_ID_SELECTED_SIZE); //Load the answer from  the saved prefernce
        preferenceUserPollParticipateCount = MApplication.loadArray(userPollActivity, userPollParticipateCount, Constants.USER_POLL_PARTICIPATE_COUNT_ARRAY, Constants.USER_POLL_PARTICIPATE_COUNT_SIZE); //Load the participate count  the saved prefernce
        //If the array has 1,then the radio options is set checked as true
        //else it is set as false
        if (preferenceUserPollLikeUser.get(position).equals(1)) {
        ...
        if (("").equals(pollImage1) && ("").equals(pollImage2)) {   //question images is empty then the visiblity o fthe view will be gone
            ...
            if (!("").equals(pollImage1) && !("").equals(pollImage2)) {
                //question images is not empty then the url is binded into the image view
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.imageQuestion1MultipleOptionsUserPoll,R.drawable.placeholder_image);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.imageQuestion2MultipleOptionsUserPoll,R.drawable.placeholder_image);
                //If the image1 question is not empty then image 2 is empty then
                //view is visible based on that
            } else if (!("").equals(pollImage1) && ("").equals(pollImage2)) {
                holder.singleOptionMultipleOptionsUserPoll.setVisibility(View.VISIBLE);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.singleOptionMultipleOptionsUserPoll,R.drawable.placeholder_image);
                holder.imageQuestion1MultipleOptionsUserPoll.setVisibility(View.GONE);
                holder.imageQuestion2MultipleOptionsUserPoll.setVisibility(View.GONE);
                //If the image1 question is  empty then image 2 is not  empty then
                //view is visible based on that
                ...
                holder.singleOptionMultipleOptionsUserPoll.setVisibility(View.VISIBLE);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage2,holder.singleOptionMultipleOptionsUserPoll,R.drawable.placeholder_image);
                holder.imageQuestion1MultipleOptionsUserPoll.setVisibility(View.GONE);
                holder.imageQuestion2MultipleOptionsUserPoll.setVisibility(View.GONE);
            } else {
                holder.imageQuestion1MultipleOptionsUserPoll.setVisibility(View.GONE);
        ...
        if (("").equals(pollAnswer1)) { //If the poll answer option is empty then the view will invisible
            holder.radioOptions1MultipleOptionsUserPoll.setVisibility(View.GONE);
        } else if (!("").equals(pollAnswer1)) {//If the poll answer option is not empty then the view will invisible
        ...
        if (("").equals(pollAnswer2)) {//If the poll answer option is empty then the view will invisible
            holder.radioOptions2MultipleOptionsUserPoll.setVisibility(View.GONE);
        } else if (!("").equals(pollAnswer2)) { //If the poll answer option is not empty then the view will invisible
        ...
        if (("").equals(pollAnswer3)) { //If the poll answer option is empty then the view will invisible
        ...
        } else if (!("").equals(pollAnswer3)) {  //If the poll answer option is not empty then the view will invisible
            ...
            if (("").equals(pollAnswer4)) {   //If the poll answer option is empty then the view will invisible
                holder.radioOptions4MultipleOptionsUserPoll.setVisibility(View.GONE);
            } else if (!("").equals(pollAnswer4)) { //If the poll answer option is not empty then the view will invisible
        ...
        holder.txtNameMultipleOptionsUserPoll.setText(MApplication.getDecodedString(userPollResponse.getUserInfo().getUserName()));
        //Setting the updating to=ime in text view
        holder.txtTimeMultipleOptionsUserPoll.setText(MApplication.getTimeDifference(userPollResponse.getUpdatedAt()));
        //Setting the poll question in text view
        holder.txtQuestionMultipleOptionsUserPoll.setText(pollQuestion);
        //Setting the category intext view
        holder.txtCategoryMultipleOptionsUserPoll.setText(userPollResponse.getCategory().getCategory().getCategoryName());
        //Setting the user profile image
        Utils.loadImageWithGlideRounderCorner(userPollActivity,userPollResponse.getUserInfo().getUserProfileImg().replaceAll(" ", "%20"),holder.imgProfileMultipleOptionsUserPoll,R.drawable.placeholder_image);
        //Setting the text participate count from the array list based on the position
        holder.txtCountsMultipleOptionsUserPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(position)));
        //holder view2
...
//Interface definition for a callback to be invoked when a view is clicked.
        ...
        //Interface definition for a callback to be invoked when the checked state of a compound button changed.
        holder.radioGroupOptionsMultipleOptionsUserPoll.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                int clickPosition = position;
                userPollResponse = getItem(clickPosition);
    ...
    private void optionClickAction(int checkedId) {
        switch (checkedId) {
            ...
            case R.id.option3:
                ...
                pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer3();
                break;
            case R.id.option4:
                //Setting the value for the variable
                pollAnswerSelectedId = "4";
                pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer4();
                break;
            default:
                break;
        }
    ...
    private void shareClickAction(int clickPosition) {
        ...
        MApplication.shareGmail(userPollActivity, shareUrl, MApplication.getString(userPollActivity, Constants.PROFILE_USER_NAME));
    }
    ...
    private void likeClickAction(PrivatePollResponseModel.Results.Data myPollResponse) {
        //Poll id from the response
        String id = myPollResponse.getUserPollsQuestion().getId();
        // It can be used with startActivity to launch an Activity
        Intent details = new Intent(userPollActivity, PrivatePollLikes.class);
    ...
    private void validateViewLayoutThree(final ViewHolderLayoutThree holder, final int position) {
        ...
        prefrenceUserPollLikeCount = MApplication.loadArray(userPollActivity, userPollLikeCount, Constants.USER_POLL_LIKES_COUNT_ARRAY, Constants.USER_POLL_LIKES_COUNT_SIZE);
        //Load the COMMENTS count from  the saved prefernce
        prefrenceUserPollCommentsCount = MApplication.loadArray(userPollActivity, userPollcommentsCount, Constants.USER_POLL_COMMENTS_COUNT, Constants.USER_POLL_COMMENTS_SIZE);
        //Load the like user from  the saved prefernce
        preferenceUserPollLikeUser = MApplication.loadArray(userPollActivity, userPollLikesUser, Constants.USER_POLL_LIKES_USER_ARRAY, Constants.USER_POLL_LIKES_USER_SIZE);
        //Load the poll id from  the saved prefernce
        preferenceUserPollIdAnswer = MApplication.loadStringArray(userPollActivity, userPollIdAnwserCheck, Constants.USER_POLL_ID_ANSWER_ARRAY, Constants.USER_POLL_ID_ANSWER_SIZE);
        ...
        if (("").equals(pollImage1) && ("").equals(pollImage2)) {
            ...
            //question images is not empty then the url is binded into the image view
            if (!("").equals(pollImage1) && !("").equals(pollImage2)) {
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.imageQuestion1PhotoComparisonUserPoll,R.drawable.placeholder_image);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage2,holder.imageQuestion2PhotoComparisonUserPoll,R.drawable.placeholder_image);
                //If the image1 question is not empty then image 2 is empty then
                //view is visible based on that
            } else if (!("").equals(pollImage1) && ("").equals(pollImage2)) {
        ...
        if (("").equals(pollAnswer1)) {
            ...
            Utils.loadImageWithGlideRounderCorner(userPollActivity,pollAnswer1.replaceAll(" ", "%20"),holder.imageAnswer1PhotoComparisonUserPoll,R.drawable.placeholder_image);
        }
        //If the poll answer option is empty then the view will invisible
        if (("").equals(pollAnswer2)) {
            ...
            Utils.loadImageWithGlideRounderCorner(userPollActivity,pollAnswer2.replaceAll(" ", "%20"),holder.imageAnswer2PhotoComparisonUserPoll,R.drawable.placeholder_image);
        }
        //If the poll answer option is empty then the view will invisible
        if (("").equals(pollAnswer3)) {
            ...
            Utils.loadImageWithGlideRounderCorner(userPollActivity,pollAnswer3.replaceAll(" ", "%20"),holder.imageAnswer3PhotoComparisonUserPoll,R.drawable.placeholder_image);
            //If the poll answer option is empty then the view will invisible
            if (("").equals(pollAnswer4)) {
                ...
                holder.imageAnswer3PhotoComparisonUserPoll.setVisibility(View.VISIBLE);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollAnswer4.replaceAll(" ", "%20"),holder.imageAnswer4PhotoComparisonUserPoll,R.drawable.placeholder_image);
        ...
        if (preferenceUserPollIdAnswer.contains(userPollResponse.getUserPollsQuestion().getId())) {
            ...
            String value = preferenceUserPollIdAnswerSelected.get(answeredPosition);
            //If the value matches then the radio option willbec cheked ,text color will be black and clickable will be false.
            if (userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer1().equals(value)) {
                holder.radioOptions1PhotoComparisonUserPoll.setChecked(true);
            } else if (userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer2().equals(value)) {
                holder.radioOptions2PhotoComparisonUserPoll.setChecked(true);
            } else if (userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer3().equals(value)) {
                holder.radioOptions3PhotoComparisonUserPoll.setChecked(true);
            } else if (userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer4().equals(value)) {
        ...
        holder.txtNamePhotoComparisonUserPoll.setText(MApplication.getDecodedString(userPollResponse.getUserInfo().getUserName()));
        //Setting the updated time
        holder.txtTimePhotoComparisonUserPoll.setText(MApplication.getTimeDifference(userPollResponse.getUpdatedAt()));
        //Setting the category name
        holder.txtCategoryPhotoComparisonUserPoll.setText(userPollResponse.getCategory().getCategory().getCategoryName());
        //Setting the user profile image
        Utils.loadImageWithGlideRounderCorner(userPollActivity,userPollResponse.getUserInfo().getUserProfileImg().replaceAll(" ", "%20"),holder.imgProfilePhotoComparisonUserPoll,R.drawable.placeholder_image);
        //Setting the participate count from the arraylist based on the position
        holder.txtCountPhotoComparisonUserPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(position)));
    ...
    private void holder3ViewOnClick(final ViewHolderLayoutThree holder, final int position) {
        ...
        holder.imageAnswer1PhotoComparisonUserPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userPollResponse = getItem(clickPosition);
                //poll answer url
                pollAnswer1 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer1().replaceAll(" ", "%20");
        ...
        holder.imageAnswer2PhotoComparisonUserPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userPollResponse = getItem(clickPosition);
                //poll answer url
                pollAnswer2 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer2().replaceAll(" ", "%20");
                //Calling a method to on click
        ...
        holder.imageAnswer3PhotoComparisonUserPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userPollResponse = getItem(clickPosition);
                //poll answer url
                pollAnswer3 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer3().replaceAll(" ", "%20");
                //Calling a method to on click
        ...
        holder.imageAnswer4PhotoComparisonUserPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userPollResponse = getItem(clickPosition);
                //poll answer url
                pollAnswer4 = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer4().replaceAll(" ", "%20");
                //Calling a method to on click
        ...
        holder.radioOptions1PhotoComparisonUserPoll.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(!view.isClickable()){
                    ...
                    //poll answer url
                    pollAnswerSelectedId = "1";
                    pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer1().replaceAll(" ", "%20");
        ...
        holder.radioOptions2PhotoComparisonUserPoll.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(!view.isClickable()){
                    ...
                    //poll answer url
                    pollAnswerSelectedId = "2";
                    pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer2().replaceAll(" ", "%20");
                    optionSelection(userPollResponse, clickPosition, null, null, holder, null);
                }
                return false;
            }
        ...
        holder.radioOptions3PhotoComparisonUserPoll.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(!view.isClickable()){
                    ...
                    //poll answer url
                    pollAnswerSelectedId = "3";
                    pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer3().replaceAll(" ", "%20");
                    optionSelection(userPollResponse, clickPosition, null, null, holder, null);
                }
                return false;
            }
        ...
        holder.radioOptions4PhotoComparisonUserPoll.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(!view.isClickable()){
                    ...
                    //poll answer url
                    pollAnswerSelectedId = "4";
                    pollAnswer = userPollResponse.getUserPollsQuestion().getUserPollsAns().getPollAnswer4().replaceAll(" ", "%20");
                    optionSelection(userPollResponse, clickPosition, null, null, holder, null);
                }
                return false;
            }
        ...
        //Interface definition for a callback to be invoked when a view is clicked.
        holder.radioOptions1PhotoComparisonUserPoll.setOnCheckedChangeListener(new RadioButton.OnCheckedChangeListener() {
            @Override
        ...
        //Interface definition for a callback to be invoked when a view is clicked.
        holder.radioOptions2PhotoComparisonUserPoll.setOnCheckedChangeListener(new RadioButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                //Click position
                int clickPosition = position;
        ...
        //Interface definition for a callback to be invoked when a view is clicked.
        holder.radioOptions3PhotoComparisonUserPoll.setOnCheckedChangeListener(new RadioButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                //Click position
                int clickPosition = position;
        ...
        //Interface definition for a callback to be invoked when a view is clicked.
        holder.radioOptions4PhotoComparisonUserPoll.setOnCheckedChangeListener(new RadioButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                //Click position
                int clickPosition = position;
    ...
    private void validateViewLayoutFour(final ViewHolderLayoutFour holder, final int position) {
        ...
        if (("").equals(pollImage1)&& ("").equals(pollImage2)) {
            ...
            if (!("").equals(pollImage1)&& !("").equals(pollImage2)) {
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.imageQuestion1YouTubeUrlUserPoll,R.drawable.placeholder_image);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.imageQuestion2YouTubeUrlUserPoll,R.drawable.placeholder_image);
                ...
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage1,holder.singleOptionYouTubeUrlUserPoll,R.drawable.placeholder_image);
                holder.imageQuestion1YouTubeUrlUserPoll.setVisibility(View.GONE);
                holder.imageQuestion2YouTubeUrlUserPoll.setVisibility(View.GONE);
                //If the question image 2 is not empty visiblity will be visible
            } else if (("").equals(pollImage1)&& !("").equals(pollImage2)) {
                holder.singleOptionYouTubeUrlUserPoll.setVisibility(View.VISIBLE);
                Utils.loadImageWithGlideRounderCorner(userPollActivity,pollImage2,holder.singleOptionYouTubeUrlUserPoll,R.drawable.placeholder_image);
                holder.imageQuestion1YouTubeUrlUserPoll.setVisibility(View.GONE);
                holder.imageQuestion2YouTubeUrlUserPoll.setVisibility(View.GONE);
            } else {
                holder.imageQuestion1YouTubeUrlUserPoll.setVisibility(View.GONE);
        ...
        holder.txtNameYouTubeUrlUserPoll.setText(MApplication.getDecodedString(userPollResponse.getUserInfo().getUserName()));
        //Setting the updted time
        holder.txtTimeYouTubeUrlUserPoll.setText(MApplication.getTimeDifference(userPollResponse.getUpdatedAt()));
        //Setting the category name in text view
        holder.txtCategoryYouTubeUrlUserPoll.setText(userPollResponse.getCategory().getCategory().getCategoryName());
        //Setting the user profile image
        Utils.loadImageWithGlideRounderCorner(userPollActivity,userPollResponse.getUserInfo().getUserProfileImg().replaceAll(" ", "%20"),holder.imgProfileYouTubeUrlUserPoll,R.drawable.placeholder_image);
        //Setting the count from the arraylist
        holder.txtVideoUrlCountYouTubeUrlUserPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(position)));
    ...
    private void holderView4OnClickListner(final ViewHolderLayoutFour holder,final int position) {
        ...
        holder.singleOptionYouTubeUrlUserPoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                youTubeUrl = userPollResponse.getUserPollsQuestion().getYouTubeUrl(); //Getting the url from the response
                ...
                //else toast message
                if (MApplication.isNetConnected((Activity) userPollActivity)) {
                    Intent a = new Intent(userPollActivity, VideoLandscapeActivity.class);
                    userPollActivity.startActivity(a);
                } else {
                    Toast.makeText(userPollActivity, userPollActivity.getResources().getString(R.string.check_internet_connection),
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                , new Callback<LikeUnLikeResposneModel>() {
                    ...
                    public void success(LikeUnLikeResposneModel likesUnlike, Response response) {
                        ...
                        if (("1").equals(likesUnlike.getResults())) {
                            ...
                            //Saving it in array
                            MApplication.saveArray(userPollActivity, preferenceUserPollLikeUser, Constants.USER_POLL_LIKES_USER_ARRAY, Constants.USER_POLL_LIKES_USER_SIZE);
                        } else {
                            //Changing the value in array list in a particular position
                        ...
                        MApplication.saveArray(userPollActivity, prefrenceUserPollLikeCount, Constants.USER_POLL_LIKES_COUNT_ARRAY, Constants.USER_POLL_LIKES_COUNT_SIZE);
                        //If holder1 is not null
                        if (holder1 != null) {
                            //Changing the value in textview
                            holder1.txtLikeYesOrNoUserPoll.setText(String.valueOf(prefrenceUserPollLikeCount.get(clickPosition)));
                            //If holder2 is not null
                        } else if (holder2 != null) {
                            //Changing the value in textview
                            holder2.txtLikeMultipleOptionsUserPoll.setText(String.valueOf(prefrenceUserPollLikeCount.get(clickPosition)));
                            //If holder3 is not null
                        } else if (holder3 != null) {
                            //Changing the value in textview
                            holder3.txtLikePhotoComparisonUserPoll.setText(String.valueOf(prefrenceUserPollLikeCount.get(clickPosition)));
                            //If holder4 is not null
                        } else if (holder4 != null) {
                            //Changing the value in textview
                            holder4.txtLikeYouTubeUrlUserPoll.setText(String.valueOf(prefrenceUserPollLikeCount.get(clickPosition)));
                        }
                    }
     ...
     */
    private void optionSelection(final PrivatePollResponseModel.Results.Data userPollResponse, final int clickPosition, final ViewHolderLayoutOne holder1, final ViewHolderLayoutTwo holder2, final ViewHolderLayoutThree holder3, final ViewHolderLayoutFour holder4) {

        //Getting the id from the response
        String pollId = this.userPollResponse.getUserPollsQuestion().getId();
        //Getting the poll answer id from the response
        String pollAnswerId = this.userPollResponse.getUserPollsQuestion().getUserPollsAns().getId();
                ...
                , new Callback<PollParticipateResponseModel>() {
                    ...
                    public void success(PollParticipateResponseModel pollParticipateResponseModel, Response response) {
                        ...
                        if (("1").equals(pollParticipateResponseModel.getSuccess())) {
                            ...
                            int participateCount = Integer.parseInt(userPollResponse.getPollParticipateCount()) + 1;
                            //Setting participate count in the arraylist
                            preferenceUserPollParticipateCount.set(clickPosition, participateCount);
                            //Saving in prefernce
                            MApplication.saveArray(userPollActivity, preferenceUserPollParticipateCount, Constants.USER_POLL_PARTICIPATE_COUNT_ARRAY, Constants.USER_POLL_PARTICIPATE_COUNT_SIZE);
                            //Saving in prefernce
                            MApplication.saveStringArray(userPollActivity, preferenceUserPollIdAnswer, Constants.USER_POLL_ID_ANSWER_ARRAY, Constants.USER_POLL_ID_ANSWER_SIZE);
                            //Saving in prefernce
                            MApplication.saveStringArray(userPollActivity, preferenceUserPollIdAnswerSelected, Constants.USER_POLL_ID_ANSWER_SELECTED_ARRAY, Constants.USER_POLL_ID_SELECTED_SIZE);
                            ...
                            if (("1").equals(PrivatePollsCustomAdapter.this.userPollResponse.getUserPollsQuestion().getPollType())) {
                                ...
                                Log.e("check",String.valueOf(preferenceUserPollParticipateCount.get(clickPosition)+""));
                                //Setting the value in participate count
                                holder1.txtCountsYesOrNoPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(clickPosition)));
                                ...
                                holder2.radioOptions1MultipleOptionsUserPoll.setClickable(false);
                                holder2.radioOptions2MultipleOptionsUserPoll.setClickable(false);
                                holder2.radioOptions3MultipleOptionsUserPoll.setClickable(false);
                                holder2.radioOptions4MultipleOptionsUserPoll.setClickable(false);
                                //If it is checked,then the text view sis set as black
                                if (holder2.radioOptions1MultipleOptionsUserPoll.isChecked()) {
                                    holder2.radioOptions1MultipleOptionsUserPoll.setTextColor(Color.BLACK);
                                } else if (holder2.radioOptions2MultipleOptionsUserPoll.isChecked()) {
                                    holder2.radioOptions2MultipleOptionsUserPoll.setTextColor(Color.BLACK);
                                } else if (holder2.radioOptions3MultipleOptionsUserPoll.isChecked()) {
                                    holder2.radioOptions3MultipleOptionsUserPoll.setTextColor(Color.BLACK);
                                } else if (holder2.radioOptions4MultipleOptionsUserPoll.isChecked()) {
                                    holder2.radioOptions4MultipleOptionsUserPoll.setTextColor(Color.BLACK);
                                }
                                //Setting the value in participate count
                                holder2.txtCountsMultipleOptionsUserPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(clickPosition)));
                            } else if (("3").equals(PrivatePollsCustomAdapter.this.userPollResponse.getUserPollsQuestion().getPollType())) {
                                //Setting the clickable as false
                                holder3.radioOptions1PhotoComparisonUserPoll.setClickable(false);
                                holder3.radioOptions2PhotoComparisonUserPoll.setClickable(false);
                                holder3.radioOptions3PhotoComparisonUserPoll.setClickable(false);
                                holder3.radioOptions4PhotoComparisonUserPoll.setClickable(false);
                                //If it is checked,then the text view sis set as black
                                if (holder3.radioOptions1PhotoComparisonUserPoll.isEnabled()) {
                                    holder3.radioOptions1PhotoComparisonUserPoll.setTextColor(Color.BLACK);
                                } else if (holder3.radioOptions2PhotoComparisonUserPoll.isEnabled()) {
                                    holder3.radioOptions2PhotoComparisonUserPoll.setTextColor(Color.BLACK);
                                } else if (holder3.radioOptions3PhotoComparisonUserPoll.isEnabled()) {
                                    holder3.radioOptions3PhotoComparisonUserPoll.setTextColor(Color.BLACK);
                                } else if (holder3.radioOptions4PhotoComparisonUserPoll.isEnabled()) {
                                    holder3.radioOptions4PhotoComparisonUserPoll.setTextColor(Color.BLACK);
                                }
                                //Setting the value in participate count
                                holder3.txtCountPhotoComparisonUserPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(clickPosition)));
                                ...
                                if (holder4.radioOptions1YouTubeUrlUserPoll.isChecked()) {
                                    holder4.radioOptions1YouTubeUrlUserPoll.setTextColor(Color.BLACK);
                                } else if (holder4.radioOptions2YouTubeUrlUserPoll.isChecked()) {
                                    holder4.radioOptions2YouTubeUrlUserPoll.setTextColor(Color.BLACK);
                                } else if (holder4.radioOptions3YouTubeUrlUserPoll.isChecked()) {
                                    holder4.radioOptions3YouTubeUrlUserPoll.setTextColor(Color.BLACK);
                                } else if (holder4.radioOptions4YouTubeUrlUserPoll.isChecked()) {
                                    holder4.radioOptions4YouTubeUrlUserPoll.setTextColor(Color.BLACK);
                                }
                                //Setting the value in participate count
                                holder4.txtVideoUrlCountYouTubeUrlUserPoll.setText(String.valueOf(preferenceUserPollParticipateCount.get(clickPosition)));
                            }
                            notifyDataSetChanged();
                            //Toast message will display
                            Toast.makeText(userPollActivity, pollParticipateResponseModel.getMsg(),
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(userPollActivity, pollParticipateResponseModel.getMsg(),
                                    Toast.LENGTH_SHORT).show();
    ...
    private void commentClickAction(int clickPosition) {
        //response from the server
        userPollResponse = getItem(clickPosition);
        String id = userPollResponse.getUserPollsQuestion().getId();
        //Moving from one activity to another activity
        Intent details = new Intent(userPollActivity, PrivatePollComments.class);
        //Passing the value from one activity to another
        details.putExtra(Constants.POLL_ID, id);
        //Passing the value from one activity to another
