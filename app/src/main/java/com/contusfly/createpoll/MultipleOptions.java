...
public class MultipleOptions extends Activity implements OnTaskCompleted {
    ...
    private Activity mMultipleOptions;
    ...
    private void init() {
        ...
        editAnswer1 =  findViewById(R.id.editAnswer1);
        editAnswer2 =  findViewById(R.id.editAnswer2);
        editAnswer3 =  findViewById(R.id.editAnswer3);
        editAnswer4 =  findViewById(R.id.editAnswer4);
    ...
    protected void onResume() {
        super.onResume();
        mCategory = MApplication.loadStringArray(mMultipleOptions, mCategory, com.contus.app.Constants.ACTIVITY_CATEGORY_INFO, com.contus.app.Constants.ACTIVITY_CATEGORY_INFO_SIZE);
...
//                        // shouldShowRequestPermissionRationale will return true
    ...
    {
        DatabaseHelper dbhelper = new DatabaseHelper(mMultipleOptions);
        ...
        GroupCheckListAdapter sd = new GroupCheckListAdapter(mMultipleOptions, groupsList);
    ...
    private void serviceCallForGroups() {
        ...
        call.enqueue(new retrofit2.Callback<JsonElement>() {
            ...
            public void onFailure(Call<JsonElement> call, Throwable t) {
                Toast.makeText(mMultipleOptions, ""+t, Toast.LENGTH_SHORT).show();
            }
        });
